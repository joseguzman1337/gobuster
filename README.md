...
```bash
apt install gobuster -y && cd /root && go install github.com/OJ/gobuster@latest && cd /root && git clone https://github.com/OJ/gobuster.git && cd gobuster && go get && go build && go install
```
